...
var BFHCountriesList = {
	...
	BFHCurrenciesList = {
		BTC: { label: "Bitcoin", currencyflag: "฿", symbol: "BTC" },
		AED: {
...
+(function (a) {
	...
	function d() {
		...
		a(f).each(function (c) {
			return (
				(b = e(a(this))),
				b.hasClass("open")
					? (b.trigger((c = a.Event("hide.bfhcolorpicker"))),
					  c.isDefaultPrevented()
							? !0
							: void b.removeClass("open").trigger("hidden.bfhcolorpicker"))
					: !0
			);
		});
	}
	...
	var f = "[data-toggle=bfh-colorpicker]",
		g = function (b, c) {
			(this.options = a.extend({}, a.fn.bfhcolorpicker.defaults, c)),
				(this.$element = a(b)),
				this.initPopover();
		};
	g.prototype = {
		...
		initPalette: function () {
			var a, b, c;
			(a = this.$element.find("canvas")),
				(b = a[0].getContext("2d")),
				(c = b.createLinearGradient(0, 0, a.width(), 0)),
				c.addColorStop(0, "rgb(255, 255, 255)"),
				c.addColorStop(0.1, "rgb(255,   0,   0)"),
				c.addColorStop(0.25, "rgb(255,   0, 255)"),
				c.addColorStop(0.4, "rgb(0,     0, 255)"),
				c.addColorStop(0.55, "rgb(0,   255, 255)"),
				c.addColorStop(0.7, "rgb(0,   255,   0)"),
				c.addColorStop(0.85, "rgb(255, 255,   0)"),
				c.addColorStop(1, "rgb(255,   0,   0)"),
				(b.fillStyle = c),
				b.fillRect(0, 0, b.canvas.width, b.canvas.height),
				(c = b.createLinearGradient(0, 0, 0, a.height())),
				c.addColorStop(0, "rgba(255, 255, 255, 1)"),
				c.addColorStop(0.5, "rgba(255, 255, 255, 0)"),
				c.addColorStop(0.5, "rgba(0,     0,   0, 0)"),
				c.addColorStop(1, "rgba(0,     0,   0, 1)"),
				(b.fillStyle = c),
				b.fillRect(0, 0, b.canvas.width, b.canvas.height);
		},
		initPopover: function () {
			...
			(a = ""),
				...
				"right" === this.options.align
					? (b =
							'<span class="input-group-addon"><span class="bfh-colorpicker-icon"></span></span>')
					: (a =
							'<span class="input-group-addon"><span class="bfh-colorpicker-icon"></span></span>'),
				this.$element.html(
					'<div class="input-group bfh-colorpicker-toggle" data-toggle="bfh-colorpicker">' +
						...
						'" readonly>' +
						b +
						'</div><div class="bfh-colorpicker-popover"><canvas class="bfh-colorpicker-palette" width="384" height="256"></canvas></div>'
				),
				this.$element
					.on("click.bfhcolorpicker.data-api", f, g.prototype.toggle)
					.on(
						"mousedown.bfhcolorpicker.data-api",
						"canvas",
						g.prototype.mouseDown
					)
					.on(
						"click.bfhcolorpicker.data-api",
		...
		updateVal: function (a, b) {
			...
			(h = 5),
				...
				(g = Math.round(g / h) * h),
				0 > f && (f = 0),
				f >= d.width() && (f = d.width() - 1),
				0 > g && (g = 0),
				g > d.height() && (g = d.height()),
				(i = e.getImageData(f, g, 1, 1)),
				(j = c(i.data[0], i.data[1], i.data[2])),
				j !== this.$element.val() &&
					(this.$element.val(j),
		...
		mouseDown: function (b) {
			...
			(c = a(this)),
				...
				a(document)
					.on(
						"mousemove.bfhcolorpicker.data-api",
						{ colorpicker: d },
						g.prototype.mouseMove
					)
					.one(
						"mouseup.bfhcolorpicker.data-api",
						{ colorpicker: d },
						g.prototype.mouseUp
					);
		},
		mouseMove: function (a) {
			var b;
			(b = a.data.colorpicker),
				b.data("bfhcolorpicker").updateVal(a.pageX, a.pageY);
		},
		mouseUp: function (b) {
			var c;
			(c = b.data.colorpicker),
				c.data("bfhcolorpicker").updateVal(b.pageX, b.pageY),
				a(document).off("mousemove.bfhcolorpicker.data-api"),
				c.data("bfhcolorpicker").options.close === !0 && d();
		},
		toggle: function (b) {
			var c, f, g;
			if (
				((c = a(this)),
				(f = e(c)),
				f.is(".disabled") || void 0 !== f.attr("disabled"))
			)
				return !0;
			if (((g = f.hasClass("open")), d(), !g)) {
				if (
					(f.trigger((b = a.Event("show.bfhcolorpicker"))),
	...
	(a.fn.bfhcolorpicker = function (b) {
		return this.each(function () {
			var c, d, e;
			(c = a(this)),
				(d = c.data("bfhcolorpicker")),
				(e = "object" == typeof b && b),
				(this.type = "bfhcolorpicker"),
				d || c.data("bfhcolorpicker", (d = new g(this, e))),
				"string" == typeof b && d[b].call(c);
		});
	}),
		(a.fn.bfhcolorpicker.Constructor = g),
		(a.fn.bfhcolorpicker.defaults = {
			align: "left",
			input: "form-control",
			placeholder: "",
			name: "",
	...
	var i;
	a.valHooks.div && (i = a.valHooks.div),
		(a.valHooks.div = {
			get: function (b) {
				return a(b).hasClass("bfh-colorpicker")
					? a(b).find('input[type="text"]').val()
					: i
					? i.get(b)
					: void 0;
			},
			set: function (b, c) {
				if (a(b).hasClass("bfh-colorpicker"))
					a(b).find(".bfh-colorpicker-icon").css("background-color", c),
						a(b).find('input[type="text"]').val(c);
	...
	+(function (a) {
		...
		b.prototype = {
				...
				if (this.options.available) {
					if ("string" == typeof this.options.available) {
						...
						for (b in BFHCountriesList)
							BFHCountriesList.hasOwnProperty(b) &&
								a.inArray(b, this.options.available) >= 0 &&
								(c[b] = BFHCountriesList[b]);
			...
			addCountries: function () {
				...
				(a = this.options.country),
					(c = this.getCountries()),
					this.$element.html(""),
					this.options.blank === !0 &&
						this.$element.append('<option value=""></option>');
				for (b in c)
					c.hasOwnProperty(b) &&
						this.$element.append(
							'<option value="' + b + '">' + c[b] + "</option>"
						);
				this.$element.val(a);
			},
			addBootstrapCountries: function () {
				...
				(d = this.options.country),
					...
					c.html(""),
					this.options.blank === !0 &&
						c.append('<li><a tabindex="-1" href="#" data-option=""></a></li>');
				for (e in f)
					f.hasOwnProperty(e) &&
			...
			displayCountry: function () {
				...
				(a = this.options.country),
					this.options.flags === !0
						...
						: this.$element.html(BFHCountriesList[a]);
			},
		};
		...
		(a.fn.bfhcountries = function (c) {
			...
			a(document).ready(function () {
				a(
					"form select.bfh-countries, span.bfh-countries, div.bfh-countries"
				).each(function () {
					var b;
					(b = a(this)),
	...
	+(function (a) {
		"use strict";
		var b = function (b, c) {
			(this.options = a.extend({}, a.fn.bfhcurrencies.defaults, c)),
				(this.$element = a(b)),
				this.$element.is("select") && this.addCurrencies(),
				this.$element.hasClass("bfh-selectbox") &&
					this.addBootstrapCurrencies(),
				this.$element.is("span") && this.displayCurrency();
		};
		b.prototype = {
			constructor: b,
			getCurrencies: function () {
				...
				if (this.options.available) {
					...
					for (b in BFHCurrenciesList)
						BFHCurrenciesList.hasOwnProperty(b) &&
							a.inArray(b, this.options.available) >= 0 &&
							(c[b] = BFHCurrenciesList[b]);
					return c;
				}
				
				console.log('BFHCurrenciesList: ', BFHCurrenciesList);
			...
			addCurrencies: function () {
				var a, b, c;
				(a = this.options.currency),
					(c = this.getCurrencies()),
					this.$element.html(""),
					this.options.blank === !0 &&
						this.$element.append('<option value=""></option>');
				for (b in c)
					c.hasOwnProperty(b) &&
						this.$element.append(
							'<option value="' + b + '">' + c[b].label + "</option>"
						);
				this.$element.val(a);
			},
			addBootstrapCurrencies: function () {
				var a, b, c, d, e, f, g;
				(d = this.options.currency),
					(a = this.$element.find('input[type="hidden"]')),
					(b = this.$element.find(".bfh-selectbox-option")),
					(c = this.$element.find("[role=option]")),
					(f = this.getCurrencies()),
					c.html(""),
					this.options.blank === !0 &&
						c.append('<li><a tabindex="-1" href="#" data-option=""></a></li>');
				for (e in f)
					f.hasOwnProperty(e) &&
						(this.options.flags === !0
							? ((g = f[e].currencyflag ? f[e].currencyflag : e.substr(0, 2)),
							  c.append(
									'<li><a tabindex="-1" href="#" data-option="' +
										e +
										'"><i class="glyphicon bfh-flag-' +
			...
			displayCurrency: function () {
				...
				(a = this.options.currency),
					this.options.flags === !0
						? ((b = BFHCurrenciesList[a].currencyflag
								? BFHCurrenciesList[a].currencyflag
								: a.substr(0, 2)),
						  this.$element.html(
								'<i class="glyphicon bfh-flag-' +
									b +
									'"></i> ' +
									BFHCurrenciesList[a].label
						  ))
						: this.$element.html(BFHCurrenciesList[a].label);
			},
		};
		...
		(a.fn.bfhcurrencies = function (c) {
			return this.each(function () {
				var d, e, f;
				(d = a(this)),
					(e = d.data("bfhcurrencies")),
					(f = "object" == typeof c && c),
					e || d.data("bfhcurrencies", (e = new b(this, f))),
					"string" == typeof c && e[c].call(d);
			});
		}),
			(a.fn.bfhcurrencies.Constructor = b),
			(a.fn.bfhcurrencies.defaults = {
				currency: "",
				available: "",
				flags: !1,
				blank: !0,
			...
			a(document).ready(function () {
				a(
					"form select.bfh-currencies, span.bfh-currencies, div.bfh-currencies"
				).each(function () {
					var b;
					(b = a(this)),
						b.hasClass("bfh-selectbox") && b.bfhselectbox(b.data()),
						b.bfhcurrencies(b.data());
				});
			});
	})(window.jQuery),
	+(function (a) {
		...
		function d(a, b, c, d) {
			return (
				...
				1 === b.length && (b = "0" + b),
				1 === d.length && (d = "0" + d),
				a.replace("m", b).replace("y", c).replace("d", d)
			);
		}
		function e(a, b, c) {
			var d, e, f;
			(d = [
				...
				(f = b.match(/(\d+)/g));
			for (e in d)
				if (d.hasOwnProperty(e) && d[e].part === c)
					return Number(f[e]).toString();
		}
		function f() {
			var b;
			a(h).each(function (c) {
				return (
					(b = g(a(this))),
					b.hasClass("open")
						? (b.trigger((c = a.Event("hide.bfhdatepicker"))),
						  c.isDefaultPrevented()
								? !0
								: void b.removeClass("open").trigger("hidden.bfhdatepicker"))
						: !0
				);
			});
		}
		...
		var h = "[data-toggle=bfh-datepicker]",
			i = function (b, c) {
				(this.options = a.extend({}, a.fn.bfhdatepicker.defaults, c)),
					(this.$element = a(b)),
					this.initCalendar();
			};
		i.prototype = {
				...
				(a = this.options.date),
					...
					"" === a || "today" === a || void 0 === a
						? ((b = new Date()),
						  "today" === a &&
								this.$element.val(
									d(c, b.getMonth(), b.getFullYear(), b.getDate())
								),
						  this.$element.data("month", b.getMonth()),
						  this.$element.data("year", b.getFullYear()))
						: (this.$element.val(a),
						  this.$element.data("month", Number(e(c, a, "m") - 1)),
						  this.$element.data("year", Number(e(c, a, "y"))));
			},
			setDateLimit: function (a, b) {
				var c, d;
				(d = this.options.format),
					"" !== a
						? (this.$element.data(b + "limit", !0),
						  "today" === a
								? ((c = new Date()),
								  this.$element.data(b + "day", c.getDate()),
								  this.$element.data(b + "month", c.getMonth()),
								  this.$element.data(b + "year", c.getFullYear()))
								: (this.$element.data(b + "day", Number(e(d, a, "d"))),
								  this.$element.data(b + "month", Number(e(d, a, "m") - 1)),
								  this.$element.data(b + "year", Number(e(d, a, "y")))))
						: this.$element.data(b + "limit", !1);
			},
			initCalendar: function () {
				...
				(a = ""),
					...
					this.$element.html(
						'<div class="' +
							c +
							' bfh-datepicker-toggle" data-toggle="bfh-datepicker">' +
							a +
							'<input type="text" name="' +
							this.options.name +
							'" class="' +
							...
							'" readonly>' +
							b +
							'</div><div class="bfh-datepicker-calendar"><table class="calendar table table-bordered"><thead><tr class="months-header"><th class="month" colspan="4"><a class="previous" href="#"><i class="glyphicon glyphicon-chevron-left"></i></a><span></span><a class="next" href="#"><i class="glyphicon glyphicon-chevron-right"></i></a></th><th class="year" colspan="3"><a class="previous" href="#"><i class="glyphicon glyphicon-chevron-left"></i></a><span></span><a class="next" href="#"><i class="glyphicon glyphicon-chevron-right"></i></a></th></tr><tr class="days-header"></tr></thead><tbody></tbody></table></div>'
					),
					this.$element
						.on(
							"click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api",
							h,
							i.prototype.toggle
						)
						.on(
							"click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api",
							".bfh-datepicker-calendar > table.calendar .month > .previous",
							i.prototype.previousMonth
						)
						.on(
							"click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api",
							".bfh-datepicker-calendar > table.calendar .month > .next",
							i.prototype.nextMonth
						)
						.on(
							"click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api",
							".bfh-datepicker-calendar > table.calendar .year > .previous",
							i.prototype.previousYear
						)
						.on(
							"click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api",
							".bfh-datepicker-calendar > table.calendar .year > .next",
							i.prototype.nextYear
						)
						.on(
							"click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api",
							".bfh-datepicker-calendar > table.calendar td:not(.off)",
							i.prototype.select
						)
						.on(
							"click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api",
			...
			updateCalendarHeader: function (a, b, c) {
				var d, e;
				for (
					a.find("table > thead > tr > th.month > span").text(BFHMonthsList[b]),
						a.find("table > thead > tr > th.year > span").text(c),
						d = a.find("table > thead > tr.days-header"),
						d.html(""),
						e = BFHDayOfWeekStart;
					e < BFHDaysList.length;
					e += 1
				)
			...
			checkMinDate: function (a, b, c) {
				var d, e, f, g;
				return (
					(d = this.$element.data("lowerlimit")),
					d === !0 &&
					((e = this.$element.data("lowerday")),
					(f = this.$element.data("lowermonth")),
					(g = this.$element.data("loweryear")),
					(e > a && b === f && c === g) || (f > b && c === g) || g > c)
						? !0
						: !1
				);
			},
			checkMaxDate: function (a, b, c) {
				var d, e, f, g;
				return (
					(d = this.$element.data("higherlimit")),
					d === !0 &&
					((e = this.$element.data("higherday")),
					(f = this.$element.data("highermonth")),
					(g = this.$element.data("higheryear")),
					(a > e && b === f && c === g) || (b > f && c === g) || c > g)
						? !0
						: !1
				);
			},
			checkToday: function (a, b, c) {
				...
				return (
					(d = new Date()),
					a === d.getDate() && b === d.getMonth() && c === d.getFullYear()
						? !0
						: !1
				);
			},
			updateCalendarDays: function (a, d, e) {
				...
				for (
					f = a.find("table > tbody").html(""),
						...
						k = "",
						l = 0;
					(i - BFHDayOfWeekStart + 7) % 7 > l;
					l += 1
				)
					k +=
						'<td class="off">' +
						(g - ((i - BFHDayOfWeekStart + 7) % 7) + l + 1) +
						"</td>";
				for (l = 1; h >= l; l += 1)
					(k += this.checkMinDate(l, d, e)
						? '<td data-day="' + l + '" class="off">' + l + "</td>"
						: this.checkMaxDate(l, d, e)
						? '<td data-day="' + l + '" class="off">' + l + "</td>"
						: this.checkToday(l, d, e)
						? '<td data-day="' + l + '" class="today">' + l + "</td>"
						: '<td data-day="' + l + '">' + l + "</td>"),
						c(d, e, l) === (6 + BFHDayOfWeekStart) % 7 &&
							(f.append("<tr>" + k + "</tr>"), (k = ""));
				for (
					l = 1;
					((7 - ((j + 1 - BFHDayOfWeekStart + 7) % 7)) % 7) + 1 >= l;
					l += 1
				)
					(k += '<td class="off">' + l + "</td>"),
						l === (7 - ((j + 1 - BFHDayOfWeekStart + 7) % 7)) % 7 &&
							f.append("<tr>" + k + "</tr>");
			},
			updateCalendar: function () {
				var a, b, c;
				(a = this.$element.find(".bfh-datepicker-calendar")),
					(b = this.$element.data("month")),
					(c = this.$element.data("year")),
					this.updateCalendarHeader(a, b, c),
					this.updateCalendarDays(a, b, c);
			},
			previousMonth: function () {
				...
				return (
					(b = a(this)),
					(c = g(b)),
					0 === Number(c.data("month"))
						? (c.data("month", 11), c.data("year", Number(c.data("year")) - 1))
						: c.data("month", Number(c.data("month")) - 1),
					(d = c.data("bfhdatepicker")),
					d.updateCalendar(),
					!1
				);
			},
			nextMonth: function () {
				...
				return (
					(b = a(this)),
					(c = g(b)),
					11 === Number(c.data("month"))
						? (c.data("month", 0), c.data("year", Number(c.data("year")) + 1))
						: c.data("month", Number(c.data("month")) + 1),
					(d = c.data("bfhdatepicker")),
					d.updateCalendar(),
					!1
			...
			previousYear: function () {
				...
				return (
					(b = a(this)),
					(c = g(b)),
					c.data("year", Number(c.data("year")) - 1),
					(d = c.data("bfhdatepicker")),
					d.updateCalendar(),
					!1
				);
			...
			select: function (b) {
				...
				(c = a(this)),
					...
					b.stopPropagation(),
					(e = g(c)),
					(h = e.data("bfhdatepicker")),
					(i = e.data("month")),
					(j = e.data("year")),
					(k = c.data("day")),
					e.val(d(h.options.format, i, j, k)),
					e.trigger("change.bfhdatepicker"),
					h.options.close === !0 && f();
			},
			toggle: function (b) {
				var c, d, e;
				if (
					((c = a(this)),
					(d = g(c)),
					d.is(".disabled") || void 0 !== d.attr("disabled"))
				)
					return !0;
				if (((e = d.hasClass("open")), f(), !e)) {
					if (
						(d.trigger((b = a.Event("show.bfhdatepicker"))),
						b.isDefaultPrevented())
					)
						return !0;
		...
		(a.fn.bfhdatepicker = function (b) {
			return this.each(function () {
				...
				(c = a(this)),
					...
					d || c.data("bfhdatepicker", (d = new i(this, e))),
					"string" == typeof b && d[b].call(c);
			});
		}),
			(a.fn.bfhdatepicker.Constructor = i),
			(a.fn.bfhdatepicker.defaults = {
		...
		var k;
		a.valHooks.div && (k = a.valHooks.div),
			(a.valHooks.div = {
				get: function (b) {
					return a(b).hasClass("bfh-datepicker")
						? a(b).find('input[type="text"]').val()
						: k
						? k.get(b)
						: void 0;
				...
				set: function (b, c) {
					if (a(b).hasClass("bfh-datepicker"))
						a(b).find('input[type="text"]').val(c);
	...
	+(function (a) {
		"use strict";
		var b = function (b, c) {
			(this.options = a.extend({}, a.fn.bfhfonts.defaults, c)),
				(this.$element = a(b)),
				this.$element.is("select") && this.addFonts(),
		...
		b.prototype = {
			...
			addBootstrapFonts: function () {
				...
				for (e in f)
					f.hasOwnProperty(e) &&
						c.append(
							'<li><a tabindex="-1" href="#" style=\'font-family: ' +
								f[e] +
								"' data-option=\"" +
								e +
								'">' +
		...
		(a.fn.bfhfonts = function (c) {
			return this.each(function () {
				...
				(d = a(this)),
					(e = d.data("bfhfonts")),
					(f = "object" == typeof c && c),
					e || d.data("bfhfonts", (e = new b(this, f))),
					"string" == typeof c && e[c].call(d);
			});
		}),
			(a.fn.bfhfonts.Constructor = b),
			(a.fn.bfhfonts.defaults = { font: "", available: "", blank: !0 }),
			(a.fn.bfhfonts.noConflict = function () {
				return (a.fn.bfhfonts = c), this;
			}),
			a(document).ready(function () {
				a("form select.bfh-fonts, span.bfh-fonts, div.bfh-fonts").each(
					function () {
						var b;
						(b = a(this)),
							b.hasClass("bfh-selectbox") && b.bfhselectbox(b.data()),
	...
	+(function (a) {
		"use strict";
		var b = function (b, c) {
			(this.options = a.extend({}, a.fn.bfhfontsizes.defaults, c)),
				(this.$element = a(b)),
				this.$element.is("select") && this.addFontSizes(),
				this.$element.hasClass("bfh-selectbox") && this.addBootstrapFontSizes();
		};
		b.prototype = {
			constructor: b,
			getFontsizes: function () {
				...
				if (this.options.available) {
					...
					for (b in BFHFontSizesList)
						BFHFontSizesList.hasOwnProperty(b) &&
							a.inArray(b, this.options.available) >= 0 &&
							(c[b] = BFHFontSizesList[b]);
					return c;
				}
		...
		(a.fn.bfhfontsizes = function (c) {
			return this.each(function () {
				var d, e, f;
				(d = a(this)),
					(e = d.data("bfhfontsizes")),
					(f = "object" == typeof c && c),
					e || d.data("bfhfontsizes", (e = new b(this, f))),
					"string" == typeof c && e[c].call(d);
			});
		}),
			(a.fn.bfhfontsizes.Constructor = b),
			(a.fn.bfhfontsizes.defaults = { fontsize: "", available: "", blank: !0 }),
			(a.fn.bfhfontsizes.noConflict = function () {
				return (a.fn.bfhfontsizes = c), this;
			}),
			a(document).ready(function () {
				a(
					"form select.bfh-fontsizes, span.bfh-fontsizes, div.bfh-fontsizes"
				).each(function () {
					var b;
					(b = a(this)),
						b.hasClass("bfh-selectbox") && b.bfhselectbox(b.data()),
						b.bfhfontsizes(b.data());
				});
			});
	})(window.jQuery),
	+(function (a) {
		"use strict";
		var b = function (b, c) {
			(this.options = a.extend({}, a.fn.bfhgooglefonts.defaults, c)),
				(this.$element = a(b)),
				this.$element.is("select") && this.addFonts(),
				this.$element.hasClass("bfh-selectbox") && this.addBootstrapFonts();
		};
		b.prototype = {
			...
			getFonts: function () {
				...
				if (((c = []), this.options.subset))
					for (b in BFHGoogleFontsList.items)
						BFHGoogleFontsList.items.hasOwnProperty(b) &&
							a.inArray(
								this.options.subset,
								BFHGoogleFontsList.items[b].subsets
							) >= 0 &&
							(c[BFHGoogleFontsList.items[b].family] = {
					...
					for (b in BFHGoogleFontsList.items)
						BFHGoogleFontsList.items.hasOwnProperty(b) &&
							a.inArray(
								BFHGoogleFontsList.items[b].family,
			...
			addBootstrapFonts: function () {
				...
				(d = this.options.font),
					...
					this.options.blank === !0 &&
						c.append(
							'<li><a tabindex="-1" href="#" data-option="" style="background-image: none;"></a></li>'
						);
				for (e in f)
					f.hasOwnProperty(e) &&
						c.append(
							'<li><a tabindex="-1" href="#" style="background-position: 0 -' +
								(30 * f[e].index - 2) +
								'px;" data-option="' +
								f[e].info.family +
								'">' +
		...
		(a.fn.bfhgooglefonts = function (c) {
			return this.each(function () {
				var d, e, f;
				(d = a(this)),
					(e = d.data("bfhgooglefonts")),
					(f = "object" == typeof c && c),
					e || d.data("bfhgooglefonts", (e = new b(this, f))),
					"string" == typeof c && e[c].call(d);
			});
		}),
			(a.fn.bfhgooglefonts.Constructor = b),
			(a.fn.bfhgooglefonts.defaults = {
				font: "",
				available: "",
				subset: "",
				blank: !0,
			...
			a(document).ready(function () {
				a(
					"form select.bfh-googlefonts, span.bfh-googlefonts, div.bfh-googlefonts"
				).each(function () {
					var b;
					(b = a(this)),
						b.hasClass("bfh-selectbox") && b.bfhselectbox(b.data()),
						b.bfhgooglefonts(b.data());
				});
			});
	})(window.jQuery),
	+(function (a) {
		"use strict";
		var b = function (b, c) {
			(this.options = a.extend({}, a.fn.bfhlanguages.defaults, c)),
				(this.$element = a(b)),
				this.$element.is("select") && this.addLanguages(),
				this.$element.is("span") && this.displayLanguage(),
				this.$element.hasClass("bfh-selectbox") && this.addBootstrapLanguages();
		};
		b.prototype = {
			constructor: b,
			getLanguages: function () {
				...
				if (this.options.available) {
					...
					for (b in this.options.available)
						this.options.available.hasOwnProperty(b) &&
							(-1 !== this.options.available[b].indexOf("_")
								? ((a = this.options.available[b].split("_")),
								  (c[a[0]] = { name: BFHLanguagesList[a[0]], country: a[1] }))
								: (c[this.options.available[b]] =
										BFHLanguagesList[this.options.available[b]]));
					return c;
				}
						...
						(b[c].hasOwnProperty("name")
							? this.$element.append(
									'<option value="' +
										...
										b[c].country +
										'">' +
										b[c].name.toProperCase() +
										" (" +
										BFHCountriesList[b[c].country] +
										")</option>"
							  )
							: this.$element.append(
									'<option value="' +
						  ...
						  this.options.flags === !0
								? this.$element.html(
										'<i class="glyphicon bfh-flag-' +
											a[1] +
											'"></i> ' +
											BFHLanguagesList[a[0]].toProperCase()
								  )
								: this.$element.html(
										BFHLanguagesList[a[0]].toProperCase() +
											" (" +
											BFHCountriesList[a[1]] +
											")"
								  ))
						: this.$element.html(BFHLanguagesList[a].toProperCase());
			},
		};
		...
		(a.fn.bfhlanguages = function (c) {
			return this.each(function () {
				var d, e, f;
				(d = a(this)),
					(e = d.data("bfhlanguages")),
					(f = "object" == typeof c && c),
					e || d.data("bfhlanguages", (e = new b(this, f))),
					"string" == typeof c && e[c].call(d);
			});
		}),
			(a.fn.bfhlanguages.Constructor = b),
			(a.fn.bfhlanguages.defaults = {
				language: "",
				available: "",
				flags: !1,
				blank: !0,
			...
			a(document).ready(function () {
				a(
					"form select.bfh-languages, span.bfh-languages, div.bfh-languages"
				).each(function () {
					var b;
					(b = a(this)),
						b.hasClass("bfh-selectbox") && b.bfhselectbox(b.data()),
						b.bfhlanguages(b.data());
				});
			}),
	...
	+(function (a) {
		"use strict";
		var b = function (b, c) {
			(this.options = a.extend({}, a.fn.bfhnumber.defaults, c)),
				(this.$element = a(b)),
				this.initInput();
		};
		b.prototype = {
			...
			initInput: function () {
				this.options.buttons === !0 &&
					...
					this.$element.on("change.bfhnumber.data-api", b.prototype.change),
					this.options.keyboard === !0 &&
						this.$element.on("keydown.bfhnumber.data-api", b.prototype.keydown),
					this.options.buttons === !0 &&
						this.$element
							.parent()
							.on("mousedown.bfhnumber.data-api", ".inc", b.prototype.btninc)
							.on("mousedown.bfhnumber.data-api", ".dec", b.prototype.btndec),
					this.formatNumber();
			},
			keydown: function (b) {
				var c;
				if (
					((c = a(this).data("bfhnumber")),
					c.$element.is(".disabled") || void 0 !== c.$element.attr("disabled"))
				)
					return !0;
				switch (b.which) {
					case 38:
			...
			mouseup: function (a) {
				var b, c, d;
				(b = a.data.btn),
					(c = b.$element.data("timer")),
					(d = b.$element.data("interval")),
					clearTimeout(c),
					clearInterval(d);
			},
			btninc: function () {
				var c, d;
				return (
					(c = a(this).parent().find(".bfh-number").data("bfhnumber")),
					c.$element.is(".disabled") || void 0 !== c.$element.attr("disabled")
						? !0
						: (c.increment(),
						  (d = setTimeout(function () {
								...
								(a = setInterval(function () {
									...
									c.$element.data("interval", a);
						  }, 750)),
						  c.$element.data("timer", d),
						  a(document).one("mouseup", { btn: c }, b.prototype.mouseup),
						  !0)
				);
			},
			btndec: function () {
			...
			change: function () {
				var b;
				return (
					(b = a(this).data("bfhnumber")),
					b.$element.is(".disabled") || void 0 !== b.$element.attr("disabled")
						? !0
						: (b.formatNumber(), !0)
				);
			},
			...
			getValue: function () {
				...
				return (
					(a = this.$element.val()),
					"-1" !== a && (a = String(a).replace(/\D/g, "")),
					0 === String(a).length && (a = this.options.min),
					parseInt(a)
				);
			},
			formatNumber: function () {
				...
				if (
					...
					a > this.options.max &&
						(a =
							this.options.wrap === !0 ? this.options.min : this.options.max),
					a < this.options.min &&
						(a =
							this.options.wrap === !0 ? this.options.max : this.options.min),
					this.options.zeros === !0)
				)
					for (
						b = String(this.options.max).length, c = String(a).length, d = c;
						b > d;
						d += 1
					)
						a = "0" + a;
		...
		(a.fn.bfhnumber = function (c) {
			return this.each(function () {
				...
				(d = a(this)),
					(e = d.data("bfhnumber")),
					(f = "object" == typeof c && c),
					e || d.data("bfhnumber", (e = new b(this, f))),
					"string" == typeof c && e[c].call(d);
			});
		}),
			(a.fn.bfhnumber.Constructor = b),
			(a.fn.bfhnumber.defaults = {
				min: 0,
				max: 9999,
				zeros: !1,
				keyboard: !0,
			...
			a(document).ready(function () {
				a(
					'form input[type="text"].bfh-number, form input[type="number"].bfh-number'
				).each(function () {
					var b;
	...
	+(function (a) {
		...
		function b(a, b) {
			var c, d, e, f;
			for (
				c = "", b = String(b).replace(/\D/g, ""), d = 0, e = 0;
				d < a.length;
				d += 1
			)
				/\d/g.test(a.charAt(d))
					? a.charAt(d) === b.charAt(e)
						? ((c += b.charAt(e)), (e += 1))
						: (c += a.charAt(d))
					: "d" !== a.charAt(d)
					? ("" !== b.charAt(e) || "+" === a.charAt(d)) && (c += a.charAt(d))
					: "" === b.charAt(e)
					? (c += "")
					: ((c += b.charAt(e)), (e += 1));
		...
		var e = function (b, c) {
			(this.options = a.extend({}, a.fn.bfhphone.defaults, c)),
				(this.$element = a(b)),
		...
		e.prototype = {
			...
			addFormatter: function () {
				...
				"" !== this.options.country &&
					((b = a(document).find("#" + this.options.country)),
					0 !== b.length
						? ((this.options.format = BFHPhoneFormatList[b.val()]),
						  b.on("change", { phone: this }, this.changeCountry))
			...
			change: function (e) {
				var f, g, h, i;
				return (
					(f = a(this).data("bfhphone")),
					f.$element.is(".disabled") || void 0 !== f.$element.attr("disabled")
						? !0
						: ((g = c(f.$element[0])),
						  (h = !1),
						  g === f.$element.val().length && (h = !0),
						  8 === e.which &&
								"d" !== f.options.format.charAt(f.$element.val().length) &&
								f.$element.val(
									String(f.$element.val()).substring(
										0,
										f.$element.val().length - 1
									)
								),
						  (i = b(f.options.format, f.$element.val())),
						  i === f.$element.val()
								? !0
								: (f.$element.val(i),
								  h && (g = f.$element.val().length),
								  d(f.$element[0], g),
								  !0))
				);
			},
		...
		(a.fn.bfhphone = function (b) {
			return this.each(function () {
				...
				(c = a(this)),
					(d = c.data("bfhphone")),
					(f = "object" == typeof b && b),
					d || c.data("bfhphone", (d = new e(this, f))),
					"string" == typeof b && d[b].call(c);
			});
		}),
			(a.fn.bfhphone.Constructor = e),
			(a.fn.bfhphone.defaults = { format: "", number: "", country: "" }),
	...
	+(function (a) {
		...
		function b() {
			...
			a(d).each(function (d) {
				return (
					(b = c(a(this))),
					b.hasClass("open")
						? (b.trigger((d = a.Event("hide.bfhselectbox"))),
						  d.isDefaultPrevented()
								? !0
								: void b.removeClass("open").trigger("hidden.bfhselectbox"))
						: !0
				);
			});
		}
		...
		var d = "[data-toggle=bfh-selectbox]",
			e = function (b, c) {
				(this.options = a.extend({}, a.fn.bfhselectbox.defaults, c)),
					(this.$element = a(b)),
					this.initSelectBox();
			};
		e.prototype = {
				...
				(b = ""),
					...
					this.$element.html(
						'<input type="hidden" name="' +
							this.options.name +
							'" value=""><a class="bfh-selectbox-toggle ' +
							this.options.input +
							'" role="button" data-toggle="bfh-selectbox" href="#"><span class="bfh-selectbox-option"></span><span class="' +
							this.options.icon +
							' selectbox-caret"></span></a><div class="bfh-selectbox-options"><div role="listbox"><ul role="option"></ul></div></div>'
					),
					this.$element.find("[role=option]").html(b),
			...
			toggle: function (d) {
				...
				if (((g = f.hasClass("open")), b(), !g)) {
					if (
						(f.trigger((d = a.Event("show.bfhselectbox"))),
						d.isDefaultPrevented())
					)
						return !0;
					f.toggleClass("open")
						.trigger("shown.bfhselectbox")
						.find('[role=option] > li > [data-option="' + f.val() + '"]')
						.focus();
				}
				return !1;
			},
			filter: function () {
				...
				(b = a(this)),
					(d = c(b)),
					(e = a("[role=option] li a", d)),
					e
						.hide()
						.filter(function () {
							return (
								-1 !==
								a(this).text().toUpperCase().indexOf(b.val().toUpperCase())
							);
						})
						.show();
			},
			keydown: function (b) {
				var f, g, h, i, j;
				return /(38|40|27)/.test(b.keyCode)
					? ((f = a(this)),
					  b.preventDefault(),
					  b.stopPropagation(),
					  (h = c(f)),
					  (i = h.hasClass("open")),
					  !i || (i && 27 === b.keyCode)
							? (27 === b.which && h.find(d).focus(), f.click())
							: ((g = a("[role=option] li:not(.divider) a:visible", h)),
							  g.length
									? (a("body").off(
									  ...
									  (j = g.index(g.filter(":focus"))),
									  38 === b.keyCode && j > 0 && (j -= 1),
									  40 === b.keyCode && j < g.length - 1 && (j += 1),
									  j || (j = 0),
									  g.eq(j).focus(),
									  void a("body").on(
											"mouseenter.bfh-selectbox.data-api",
			...
			select: function (d) {
				...
				return (
					...
					d.preventDefault(),
					d.stopPropagation(),
					e.is(".disabled") || void 0 !== e.attr("disabled")
						? !0
						: ((f = c(e)),
						  f.val(e.data("option")),
						  f.trigger("change.bfhselectbox"),
						  void b())
				);
			},
		};
		...
		(a.fn.bfhselectbox = function (b) {
			return this.each(function () {
				var c, d, f;
				(c = a(this)),
					(d = c.data("bfhselectbox")),
					(f = "object" == typeof b && b),
					(this.type = "bfhselectbox"),
					d || c.data("bfhselectbox", (d = new e(this, f))),
					"string" == typeof b && d[b].call(c);
			});
		}),
			(a.fn.bfhselectbox.Constructor = e),
			(a.fn.bfhselectbox.defaults = {
				icon: "caret",
				input: "form-control",
				name: "",
				value: "",
		...
		var g;
		a.valHooks.div && (g = a.valHooks.div),
			(a.valHooks.div = {
				get: function (b) {
					return a(b).hasClass("bfh-selectbox")
						? a(b).find('input[type="hidden"]').val()
						: g
						? g.get(b)
						: void 0;
				},
				set: function (b, c) {
					...
					if (a(b).hasClass("bfh-selectbox"))
						(d = a(b)),
							d.find("li a[data-option='" + c + "']").length > 0
								? (e = d.find("li a[data-option='" + c + "']").html())
								: d.find("li a").length > 0
								? (e = d.find("li a").eq(0).html())
								: ((c = ""), (e = "")),
							d.find('input[type="hidden"]').val(c),
							d.find(".bfh-selectbox-option").html(e);
	...
	+(function (a) {
		"use strict";
		var b = function (b, c) {
			(this.options = a.extend({}, a.fn.bfhslider.defaults, c)),
				(this.$element = a(b)),
				this.initSlider();
		};
		b.prototype = {
			...
			initSlider: function () {
				"" === this.options.value && (this.options.value = this.options.min),
					this.$element.html(
						'<input type="hidden" name="' +
							this.options.name +
							'" value=""><div class="bfh-slider-handle"><div class="bfh-slider-value"></div></div>'
					),
					this.$element.find('input[type="hidden"]').val(this.options.value),
					this.updateHandle(this.options.value),
					this.$element.on(
						"mousedown.bfhslider.data-api",
						b.prototype.mouseDown
					);
			},
			updateHandle: function (a) {
				var b, c, d, e;
				(e = this.options.max - this.options.min),
					(c = this.$element.width()),
					(d = this.$element.position().left),
					(b = Math.round(((a - this.options.min) * (c - 20)) / e + d)),
					this.$element.find(".bfh-slider-handle").css("left", b + "px"),
					this.$element.find(".bfh-slider-value").text(a);
			},
			updateVal: function (a) {
				var b, c, d, e, f;
				return (
					(f = this.options.max - this.options.min),
					...
					a + 20 > d && (a = d),
					(e = (a - c) / b),
					(e = Math.ceil(e * f + this.options.min)),
					e === this.$element.val()
						? !0
						: (this.$element.val(e),
						  void this.$element.trigger("change.bfhslider"))
				);
			},
			mouseDown: function () {
				var c;
				return (
					(c = a(this)),
					c.is(".disabled") || void 0 !== c.attr("disabled")
						? !0
						: void a(document)
								.on(
									"mousemove.bfhslider.data-api",
									{ slider: c },
									b.prototype.mouseMove
								)
								.one(
									"mouseup.bfhslider.data-api touchend.bfhslider.data-api",
									{ slider: c },
									b.prototype.mouseUp
								)
				);
			...
			mouseUp: function (b) {
				var c;
				(c = b.data.slider),
					c.data("bfhslider").updateVal(b.pageX),
					a(document).off(
						"mousemove.bfhslider.data-api touchmove.bfhslider.data-api"
					);
			},
		};
		...
		(a.fn.bfhslider = function (c) {
			return this.each(function () {
				...
				(d = a(this)),
					...
					(f = "object" == typeof c && c),
					(this.type = "bfhslider"),
					e || d.data("bfhslider", (e = new b(this, f))),
					"string" == typeof c && e[c].call(d);
			});
		}),
			(a.fn.bfhslider.Constructor = b),
			(a.fn.bfhslider.defaults = { name: "", value: "", min: 0, max: 100 }),
			(a.fn.bfhslider.noConflict = function () {
				return (a.fn.bfhslider = c), this;
			});
		var d;
		a.valHooks.div && (d = a.valHooks.div),
			(a.valHooks.div = {
				get: function (b) {
					return a(b).hasClass("bfh-slider")
						? a(b).find('input[type="hidden"]').val()
						: d
						? d.get(b)
						: void 0;
				...
				set: function (b, c) {
					if (a(b).hasClass("bfh-slider"))
						a(b).find('input[type="hidden"]').val(c),
							a(b).data("bfhslider").updateHandle(c);
	...
	+(function (a) {
		...
		b.prototype = {
			...
			addStates: function () {
				...
				(b = this.options.country),
					"" !== b &&
						...
						0 !== c.length &&
							((b = c.val()),
							c.on("change", { state: this }, this.changeCountry))),
					this.loadStates(b);
			},
			loadStates: function (a) {
				...
				for (c in BFHStatesList[a])
					BFHStatesList[a].hasOwnProperty(c) &&
						this.$element.append(
							'<option value="' +
								BFHStatesList[a][c].code +
								'">' +
								BFHStatesList[a][c].name +
								"</option>"
						);
				this.$element.val(b);
			},
			...
			addBootstrapStates: function () {
				...
				(b = this.options.country),
					"" !== b &&
						((c = a(document).find("#" + b)),
						0 !== c.length &&
							((b = c.find('input[type="hidden"]').val()),
							c.on(
								"change.bfhselectbox",
								{ state: this },
			...
			loadBootstrapStates: function (a) {
				...
				(e = this.options.state),
					...
					d.html(""),
					this.options.blank === !0 &&
						d.append('<li><a tabindex="-1" href="#" data-option=""></a></li>');
				for (g in BFHStatesList[a])
					BFHStatesList[a].hasOwnProperty(g) &&
						(d.append(
							'<li><a tabindex="-1" href="#" data-option="' +
								BFHStatesList[a][g].code +
								'">' +
								BFHStatesList[a][g].name +
								"</a></li>"
						),
						BFHStatesList[a][g].code === e && (f = BFHStatesList[a][g].name));
				this.$element.val(e);
			},
			...
			displayState: function () {
				...
				for (d in BFHStatesList[a])
					if (
						BFHStatesList[a].hasOwnProperty(d) &&
						BFHStatesList[a][d].code === b
					) {
		...
		(a.fn.bfhstates = function (c) {
			...
			(a.fn.bfhstates.defaults = { country: "", state: "", blank: !0 }),
			(a.fn.bfhstates.noConflict = function () {
				return (a.fn.bfhstates = c), this;
			}),
			a(document).ready(function () {
				a("form select.bfh-states, span.bfh-states, div.bfh-states").each(
					function () {
						var b;
						(b = a(this)),
							b.hasClass("bfh-selectbox") && b.bfhselectbox(b.data()),
	...
	+(function (a) {
		...
		function c() {
			...
			a(e).each(function (c) {
				return (
					(b = d(a(this))),
					b.hasClass("open")
						? (b.trigger((c = a.Event("hide.bfhtimepicker"))),
						  c.isDefaultPrevented()
								? !0
								: void b.removeClass("open").trigger("hidden.bfhtimepicker"))
						: !0
				);
			});
		}
		...
		var e = "[data-toggle=bfh-timepicker]",
			f = function (b, c) {
				(this.options = a.extend({}, a.fn.bfhtimepicker.defaults, c)),
					(this.$element = a(b)),
					this.initPopover();
			};
		f.prototype = {
				...
				(a = this.options.time),
					...
					"" === a || "now" === a || void 0 === a
						? ((c = new Date()),
						  (e = c.getHours()),
						  (f = c.getMinutes()),
						  "12h" === this.options.mode &&
								(e > 12
									? ((e -= 12), (g = " " + BFHTimePickerModes.pm), (h = "pm"))
									: ((g = " " + BFHTimePickerModes.am), (h = "am"))),
						  "now" === a &&
								this.$element
									.find('.bfh-timepicker-toggle > input[type="text"]')
									.val(b(e, f) + g),
						  this.$element.data("hour", e),
						  this.$element.data("minute", f),
						  this.$element.data("mode", h))
						: ((d = String(a).split(BFHTimePickerDelimiter)),
						  (e = d[0]),
						  (f = d[1]),
						  "12h" === this.options.mode &&
								((d = String(f).split(" ")),
								(f = d[0]),
								(h = d[1] === BFHTimePickerModes.pm ? "pm" : "am")),
						  this.$element
								.find('.bfh-timepicker-toggle > input[type="text"]')
								.val(a),
						  this.$element.data("hour", e),
			...
			initPopover: function () {
				...
				(b = ""),
					...
					"12h" === this.options.mode &&
						((g =
							'<td><div class="bfh-selectbox" data-input="' +
							this.options.input +
							'" data-value="am"><div data-value="am">' +
							BFHTimePickerModes.am +
							'</div><div data-value="pm">' +
					...
					this.$element.html(
						'<div class="' +
							d +
							' bfh-timepicker-toggle" data-toggle="bfh-timepicker">' +
							b +
							'<input type="text" name="' +
							this.options.name +
							'" class="' +
							...
							'" readonly>' +
							c +
							'</div><div class="bfh-timepicker-popover"><table class="table"><tbody><tr><td class="hour"><input type="text" class="' +
							this.options.input +
							' bfh-number"  data-min="0" data-max="' +
							h +
							'" data-zeros="true" data-wrap="true"></td><td class="separator">' +
							BFHTimePickerDelimiter +
							'</td><td class="minute"><input type="text" class="' +
							this.options.input +
							' bfh-number"  data-min="0" data-max="59" data-zeros="true" data-wrap="true"></td>' +
							g +
							"</tr></tbody></table></div>"
					),
					this.$element
						.on("click.bfhtimepicker.data-api", e, f.prototype.toggle)
						.on(
							"click.bfhtimepicker.data-api",
					...
					this.$element.find(".bfh-number").each(function () {
						...
						(b = a(this)),
							b.bfhnumber(b.data()),
							b.on("change", f.prototype.change);
					}),
					this.$element.find(".bfh-selectbox").each(function () {
						var b;
						(b = a(this)),
							b.bfhselectbox(b.data()),
							b.on("change.bfhselectbox", f.prototype.change);
					}),
					this.setTime(),
					this.updatePopover();
			},
			...
			change: function () {
				...
				return (
					...
					e &&
						...
						((f = ""),
						"12h" === e.options.mode &&
							(f = " " + BFHTimePickerModes[c.find(".bfh-selectbox").val()]),
						c
							.find('.bfh-timepicker-toggle > input[type="text"]')
							.val(
								c.find(".hour input[type=text]").val() +
									BFHTimePickerDelimiter +
									c.find(".minute input[type=text]").val() +
									f
							),
						c.trigger("change.bfhtimepicker")),
					!1
				);
			},
			toggle: function (b) {
				...
				if (((g = f.hasClass("open")), c(), !g)) {
					if (
						(f.trigger((b = a.Event("show.bfhtimepicker"))),
						b.isDefaultPrevented())
					)
						return !0;
		...
		(a.fn.bfhtimepicker = function (b) {
			return this.each(function () {
				var c, d, e;
				(c = a(this)),
					(d = c.data("bfhtimepicker")),
					(e = "object" == typeof b && b),
					(this.type = "bfhtimepicker"),
					d || c.data("bfhtimepicker", (d = new f(this, e))),
					"string" == typeof b && d[b].call(c);
			});
		}),
		...
		a.valHooks.div && (h = a.valHooks.div),
			(a.valHooks.div = {
				get: function (b) {
					return a(b).hasClass("bfh-timepicker")
						? a(b).find('.bfh-timepicker-toggle > input[type="text"]').val()
						: h
						? h.get(b)
						: void 0;
				},
				set: function (b, c) {
					var d;
					if (a(b).hasClass("bfh-timepicker"))
						(d = a(b).data("bfhtimepicker")),
							(d.options.time = c),
							d.setTime(),
							d.updatePopover();
	...
	+(function (a) {
		"use strict";
		var b = function (b, c) {
			(this.options = a.extend({}, a.fn.bfhtimezones.defaults, c)),
				(this.$element = a(b)),
				this.$element.is("select") && this.addTimezones(),
				this.$element.hasClass("bfh-selectbox") && this.addBootstrapTimezones();
		};
		b.prototype = {
			constructor: b,
			addTimezones: function () {
				...
				(b = this.options.country),
					"" !== b &&
						...
						0 !== c.length &&
							((b = c.val()),
							c.on("change", { timezone: this }, this.changeCountry))),
					this.loadTimezones(b);
			},
			loadTimezones: function (a) {
				var b, c;
				(b = this.options.timezone),
					this.$element.html(""),
					this.options.blank === !0 &&
						this.$element.append('<option value=""></option>');
				for (c in BFHTimezonesList[a])
					BFHTimezonesList[a].hasOwnProperty(c) &&
						this.$element.append(
							'<option value="' +
								c +
								'">' +
								BFHTimezonesList[a][c] +
								"</option>"
						);
				this.$element.val(b);
			},
			...
			loadBootstrapTimezones: function (a) {
				...
				for (f in BFHTimezonesList[a])
					BFHTimezonesList[a].hasOwnProperty(f) &&
						d.append(
							'<li><a tabindex="-1" href="#" data-option="' +
								f +
								'">' +
		...
		(a.fn.bfhtimezones = function (c) {
			return this.each(function () {
				var d, e, f;
				(d = a(this)),
					(e = d.data("bfhtimezones")),
					(f = "object" == typeof c && c),
					e || d.data("bfhtimezones", (e = new b(this, f))),
					"string" == typeof c && e[c].call(d);
			});
		}),
			(a.fn.bfhtimezones.Constructor = b),
			(a.fn.bfhtimezones.defaults = { country: "", timezone: "", blank: !0 }),
