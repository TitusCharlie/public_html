    ...
    $.ajax({
            ...
            success: function(data) {
                ...
                if(content.success == false)
                {
                    ...
                    swal(
                        'Success!',
                        'Hello! <br>You’ll receive a mail shortly with your login details. <br><br>Please set up your smart contract wallet following the steps in the mail. <br><br>Thank you',
                        'success'
                        );
