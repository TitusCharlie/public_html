<!-- ##### Welcome Area Start ##### -->
<!--<section class="hero-section bg-white relative section-padding bg-pt2 mr-n35" id="home" style="-->
<!--    background: linear-gradient(to bottom right,#0B65C6 50%,#105BAA 100%);">-->
<section class="hero-section bg-white relative section-padding bg-pt2 mr-n35" id="home" style="background-color: #192057!important;">
        ...
        <div class="row h-100 mb-50 align-items-center">
            ...
            <div class="col-12 col-lg-6 col-md-12">
                <div class="welcome-content mt-0 mb-5">
                    ...
                    <h1 class="wow fadeInUp main-pg-txt a-delay-2 mb-0" data-wow-delay="0.3s" style="color: #fff!important; font-size:300%;">
                    ...
                    <!--<p class="wow fadeInUp main-pg-txt a-delay-3" data-wow-delay="0.3s">-->
            ...
            <div class="col-lg-6 col-md-12">
                <div class="main-ilustration main-ilustration-4" style="/*background-size: cover;*/">
                </div>
            </div>
        </div>
    </div>
                ...
                <a href="<?= base_url() ?>deposits/new" class="col-lg-4 col-md-6 col-sm-12 mt-md-30 d-inline-block">
                    ...
                    <div class="plan-block v2 txt-center">
                        ...
                        <div class="plan-percent">
                            ...
                            <p class="text-capitalize" style="color: #192057!important;">profit <br><?= $this->security->xss_clean($plan->periodName) ?></p>
                        </div>
                        <div class="plan-content">
                            <p class="title" style="color: #192057!important;">For</p>
                            <p class="body" style="color: #192057!important;"><?= $this->security->xss_clean($plan->maturity_desc) ?></p>
                        </div>
                        <div class="plan-content1">
                            <p class="title-2" style="color: #192057!important;">Invest</p>
                            <p class="amount-range" style="color: #192057!important;"><?= to_currency($this->security->xss_clean($plan->minInvestment)) . ' - ' . to_currency($this->security->xss_clean($plan->maxInvestment)) ?></p>
                        </div>
                    </div>
                     </div> 
                </a>
...
<section class="calculator-block clearfix" id="about" style="margin-top:15%;">
    <?php echo form_open(base_url('calculator'), array( 'id' => 'calcForm' ));?>
        <div class="container" style="background-color: #192057!important;">
            <div class="row align-items-center m-4">
                <div class="col-12 col-lg-4 offset-lg-0 mt-4 mb-4">
                    <div class="form-group">
                        <label>Amount</label>
                        <input class="form-control text-dark" name="amount" placeholder="Investment Amount e.g BTC200"></input>
...
<section class="about-block special section-padding-100-70 clearfix mr-n35" id="about">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6 offset-lg-0 col-md-12 no-padding-left">
                <div class="welcome-meter wow fadeInUp mb-30 main-pg-txt a-delay-7" data-wow-delay="0.7s">
                    <img src="<?=base_url('assets/dist/img/XS_MAX.jpg')?>" alt="">
        ...
        <div class="row align-items-center">
            <div class="col-lg-4 col-md-6 col-sm-12 mt-md-30">
                <div class="intro-block v2 txt-center">
                        ...
                        <p style="color:#383636!important;">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-lg-6 offset-lg-0 col-md-12 no-padding-left">
                ...
                <!--    <img src="<?=base_url('assets/dist/img/background2.jpg')?>" alt="">-->
                <!--</div>-->
                <div class="welcome-meter wow fadeInUp mb-30 main-pg-txt a-delay-7" data-wow-delay="0.7s">
                    <img src="<?=base_url('assets/dist/img/background2.jpg')?>" alt="">
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6 col-md-12 no-padding-left">
                <div class="welcome-meter wow fadeInUp mt-5 mb-30 main-pg-txt a-delay-7" data-wow-delay="0.7s">
                    <img src="<?=base_url('assets/dist/img/background9.png')?>" alt="">
                </div>
            </div>
        </div>
    </div>
