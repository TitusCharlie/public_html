...
<body class="light-version js-focus-visible">
    <!-- ##### Header Area Start ##### -->
    <header class="" data-wow-delay="0.2s">
        <div class="classy-nav-container breakpoint-off dark left">
            <div class="container">
                ...
                <nav class="classy-navbar justify-content-between" id="dreamNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand" href="<?php echo base_url() ?>" style="width: 50%;">
                        <img class="logo-img logo-small"
                            src="<?php echo $this->security->xss_clean($this->logoDark); ?>" alt="logo" style="width:10px">
                    </a>

                    <!-- Navbar Toggler -->
                    <div class="classy-navbar-toggler demo">
                        <span class="navbarToggler"><i class="fa fa-bars" style="font-size:24px;"></i></span>
                    </div>
