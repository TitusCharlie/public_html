...
<?php }?>
<!-- ($pageTitle=="Login" OR $this->uri->segment(1)=="signup" OR $pageTitle=="Forgot Password" OR $pageTitle=="Reset Password") -->
<?php if($pageTitle=="Forgot Password" OR $pageTitle=="Reset Password") {?>
<?php } else { ?>
<!-- ##### Footer Area Start ##### -->
...
<?php if($this->chatPluginActive == 1) {?>
    <?php if($this->chatPlugin == 'Tawk') {?>
        ...
        <script type="text/javascript">
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/641742d54247f20fefe6cc00/1grtdq5bt';
            s1.charset='UTF-8';
