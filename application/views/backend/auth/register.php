    ...
    <!-- Login Container -->
        <div class="dt-login--container">
            ...
            <!--<div class="dt-login__content-wrapper">-->
                ...
                <div class="dt-login__contentchec" style="height:100vh;width: 100vh;">
                    ...
                    <div class="dt-login__content-inner">
                        <h1 align-text="center"> Let's get your registration details to</h1>
                        <div class="col-md-12">
                            <?php
                        ...
                        <?php echo form_open(base_url( 'signup' ), array( 'id' => 'registerForm' ));?>
                          <div class="row">
                            ...
                            <!-- Form Group -->
                            <div>
                                <checkbox class="dt-checkbox dt-checkbox-icon dt-checkbox-only" style="margin-bottom: 20px; color:#FFFFFF">
