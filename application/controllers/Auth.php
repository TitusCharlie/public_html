	...
	public function signup()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($result > 0) {
				...
				$body = "<html><body>";
				$body .= "<h2>A New user registration details</h2>";
				$body .= "<p>Name: " . $name . "</p>";
				...
				//customized mailer ends here
				$result1 = $this->sendEmail($to, $subject, $body, $headers);
				...
				if ($result1 > 0) {
					...
					if ($resultEmail->num_rows() > 0) {
						...
						$sent = $this->sendEmail($toEmail, $mailSubject, $mailContent);

						// echo "$sent: " . json_encode($sent);
						// exit(1);
					}
